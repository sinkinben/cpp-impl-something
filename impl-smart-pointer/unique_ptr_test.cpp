/* Copy from https://en.cppreference.com/w/cpp/memory/unique_ptr,
 * 1. replace 'std::unique_ptr' with 'unique_ptr'
 * 2. replace 'std::make_unique<D>()' with 'new D()'
 */
...
// To enable my implementation of unique_ptr or not
using impl::unique_ptr;
...
int main()
{
    ...
    // We do not support the array specification yet
    // std::cout << "\n"
